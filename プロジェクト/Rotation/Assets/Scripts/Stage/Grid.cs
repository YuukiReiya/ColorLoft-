...
public class Grid : MonoBehaviour {
    ...
    private void OnDrawGizmos()
    {
        ...
        pos += offset;
        Gizmos.DrawWireCube(pos, this.transform.lossyScale);
    }
    ...
    public bool CheckIntrusion(Vector3 pos)
    {
        ...
        //  ワールドスケール
        float xHalfScale = this.transform.lossyScale.x / 2;
        float zHalfScale = this.transform.lossyScale.z / 2;
        ...
        y = pos.y > this.transform.position.y;//高さの領域判定
